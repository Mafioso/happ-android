...
public class BaseFeedFragment extends Fragment {
    ...
    public interface ChangeColorIconToolbarListener {
        void onChangeColorIconToolbar(int drawableHome, int drawableFilter);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (dy > 0) {
                    ...
                    if (!loading && (totalItemCount - visibleItemCount)
                        ...
                        if (startDate == null || endDate == null || maxFree.equals("") || feedSearchText.equals("") || popularityEvents.equals("")) {
